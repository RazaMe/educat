...
{{--                    <p class="text-dark mb-2">Sign in with <strong>admin@white.com</strong> and the password <strong>secret</strong></p>--}}
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-danger btn-lg btn-block mb-3">{{ _('Get Started') }}</button>
                    <div class="pull-left">
                        <h6>
                            <a href="{{ route('register') }}" class="link footer-link" style="color: red">{{ _('Create Account') }}</a>
                        </h6>
                    </div>
                    <div class="pull-right">
                        <h6>
                            <a href="{{ route('password.request') }}" class="link footer-link" style="color: red">{{ _('Forgot password?') }}</a>
                        </h6>
                    </div>
                </div>
            </div>
