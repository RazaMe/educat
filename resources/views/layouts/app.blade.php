...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- CSS -->
        <link href="/assets/css/white-dashboard.css?v=1.0.0" rel="stylesheet" />
        ...
        @else
            ...
            <div class="wrapper wrapper-full-page">
                <div class="full-page {{ $contentClass ?? '' }}">
                    <div class="content"  style="height: 1000px !important;">
                        <div class="container">
                            @yield('content')
                        </div>
                    </div>
...
{{--        <script src="/assets/js/white-dashboard.min.js?v=1.0.0"></script>--}}
